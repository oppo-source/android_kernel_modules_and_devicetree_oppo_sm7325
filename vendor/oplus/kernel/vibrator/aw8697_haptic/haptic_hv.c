...
static char aw_rtp_name_170Hz[][AW_RTP_NAME_MAX] = {
	{"aw8697_rtp.bin"},
	{"aw8697_Hearty_channel_RTP_1.bin"},
	{"aw8697_Instant_channel_RTP_2.bin"},
	{"aw8697_Music_channel_RTP_3.bin"},
			 ...
			 struct device_node *np)
{
	...
	uint32_t rtp_f0_range[RTP_F0_RANGE_CNT];
	uint32_t val = 0;
	int i = 0;
	...
	val = of_property_read_u32_array(np, "oplus,rtp_f0_range", rtp_f0_range, RTP_F0_RANGE_CNT);
	if (val != 0) {
		aw_dev_info("oplus,rtp_f0_range not found");
		aw_haptic->rtp_f0_min = DEVICE_ID_0815_F0_1650;
		aw_haptic->rtp_f0_max = DEVICE_ID_0815_F0_1750;
	} else {
		aw_haptic->rtp_f0_min = rtp_f0_range[RTP_f0_MIN_INDX];
		aw_haptic->rtp_f0_max = rtp_f0_range[RTP_f0_MAX_INDX];
	}
	aw_dev_info("%s: oplus,rtp_f0_range=[%d %d]\n", __func__, aw_haptic->rtp_f0_min, aw_haptic->rtp_f0_max);
#endif
	return 0;
}
...
static void get_f0_cali_data(struct aw_haptic *aw_haptic)
{
	char f0_cali_lra = 0;
	uint32_t f0_limit = 0;
	uint32_t f0_cali_min = aw_haptic->info.f0_pre *
...
static void rtp_work_routine(struct work_struct *work)
{
	...
	if (!rtp_file) {
		...
		aw_haptic->rtp_routine_on = 1;
		if (aw_haptic->device_id == 815) {
			if (aw_haptic->rtp_f0_min == DEVICE_ID_0815_F0_1620
					&& aw_haptic->rtp_f0_max == DEVICE_ID_0815_F0_1780) {
				if (aw_haptic->f0 <= DEVICE_ID_0815_F0_1630) {
					...
					ret = request_firmware(&rtp_file,
					aw_rtp_name_170Hz[aw_haptic->rtp_file_num],
					aw_haptic->dev);
