...
#define OPLUS_PARTITION_OPLUSRESERVE_1                      "/dev/block/by-name/opporeserve1"
#define OPLUS_PARTITION_OPLUSRESERVE_1                     "/dev/block/by-name/opporeserve1"
#define OPLUSRESERVER1_PATH \
(!access(OPLUS_PARTITION_OPLUSRESERVE_1, 0) ? OPLUS_PARTITION_OPLUSRESERVE_1 : OPLUS_PARTITION_OPLUSRESERVE_1)
...
MODULE_AUTHOR("Lee <wangyang4aoplus.com>");
