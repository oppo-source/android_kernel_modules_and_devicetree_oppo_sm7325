...
static int oplus_mdss_dsi_boe_ili7838e_dsc_panel_check_esd_status(struct dsi_display *display)
{
	int rc = 0;
	unsigned char register1[30] = {0};
	unsigned char register2[30] = {0};
...
int oplus_display_status_reg_read(struct dsi_display *display)
{
	...
	} else if (!strcmp(panel->oplus_priv.vendor_name, "ILI7838E")) {
		panel_esd_status = oplus_mdss_dsi_boe_ili7838e_dsc_panel_check_esd_status(display);
